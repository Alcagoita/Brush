...
11 tickets across two independent epics.

- **Track A — Today Screen Redesign** (4 tickets, KAN-130 Epic) — ✅ All done
- **Track B — Notifications & Re-engagement** (7 tickets, KAN-118 Epic) — 6/7 done

### Remaining ticket

#### KAN-125 · Friend activity

Firebase Cloud Function on `task.completedAt` writes. Max 1 per friend per day. Task content never included.
...
- KAN-101 (sharing/friends) merged in Sprint 6 — no blocker
