...
const en = {
  ...
  onboarding: {
    ...
    nudgeTexts: [
      'Não te apetece pão?',
      'Talvez hoje seja um bom dia para café na rua.',
      'Esta é a semana para ir aos CTT.',
      'Que bom dia para fazer desporto lá fora.',
      'Esse recado que tens adiado? Continua à espera.',
      'Provavelmente há algo no frigorífico que precisa de ser substituído.',
    ],
...
const ptPT: typeof en = {
  ...
  achievements: {
    ...
    catalogue: {
      ...
      firstBrushLabel: 'Primeira passada',
      firstBrushCondition: 'Trata da tua primeira tarefa',
      rightPlaceLabel: 'No sítio certo, à hora certa',
      rightPlaceCondition: 'Trata de uma tarefa quando estás perto do sítio onde acontece',
      worthWaitLabel: 'Valeu a pena esperar',
      worthWaitCondition: 'Trata de uma tarefa que ficou aí uns dias',
      customCatLabel: 'Torna-a tua',
      customCatCondition: 'Cria uma categoria personalizada',
      outAboutLabel: 'Por aí fora',
      outAboutCondition: 'Trata de tarefas em vários tipos de sítios',
      challengeWinnerLabel: 'Primeiro a tratar',
      challengeWinnerCondition: 'Ganha um desafio contra um amigo',
      earlyBirdLabel: 'Madrugador',
      earlyBirdCondition: 'Trata de uma tarefa antes das 9:00',
      dayCompleteLabel: 'Dia concluído',
      dayCompleteCondition: 'Trata de todas as tarefas num só dia',
      onARollLabel: 'Em sequência',
      onARollCondition: 'Sequência de 3 dias a tratar tarefas',
      explorerLabel: 'Explorador',
      explorerCondition: 'Trata de 10 tarefas ligadas a localizações',
