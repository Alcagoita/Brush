...
const en = {
  ...
  tripPlanner: {
    ...
    changeTripDates: 'Change the dates',
    addTripDates: 'Add the dates',
    changeTripDatesA11y: (destination: string) => `Change the dates for ${destination}`,
    learnBiggerArea: 'Learn a bigger area',
...
const ptPT: typeof en = {
  ...
  tripPlanner: {
    ...
    changeTripDates: 'Alterar as datas',
    addTripDates: 'Adicionar as datas',
    changeTripDatesA11y: (destination: string) => `Alterar as datas de ${destination}`,
    learnBiggerArea: 'Aprender uma zona maior',
