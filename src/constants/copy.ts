...
const en = {
  ...
  settings: {
    ...
    placeNamesRowLabel: 'Place names',
    placeNamesSheetTitle: 'Choose place-name language',
    placeNamesNative: 'Country native',
...
const ptPT: typeof en = {
  ...
  settings: {
    ...
    placeNamesRowLabel: 'Nomes dos locais',
    placeNamesSheetTitle: 'Escolhe o idioma dos locais',
    placeNamesNative: 'Idioma nativo do país',
    languageEnglish: 'English',
    languagePortuguese: 'Português',
